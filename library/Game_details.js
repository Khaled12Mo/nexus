...
function changeMain(element) {
    ...
    allThumbs.forEach(removeActive);
...
function addScreenshotThumb(src, thumbDiv) {
...
function loadGameDetails() {
    ...
    var thumbDiv = document.querySelector('.gallary .photo');
    thumbDiv.innerHTML = '';
    ...
    game.screenshots.forEach(function(src) {
        addScreenshotThumb(src, thumbDiv);
    });
    ...
    var reqDiv = document.querySelector('.req-list');
    reqDiv.innerHTML =
    ...
    document.querySelector('.stat-value').textContent = game.stats.avgPlaytime;
    document.querySelectorAll('.stat-value')[1].textContent = game.stats.achievements;
